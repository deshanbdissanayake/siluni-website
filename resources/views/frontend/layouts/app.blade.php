<!DOCTYPE html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="web-assets/css/vendor/animate.min.css">
        ...
        <link rel="stylesheet" href="web-assets/css/vendor/fontawesome-pro.css">
        <link rel="stylesheet" href="web-assets/css/vendor/spacing.css">
        <link rel="stylesheet" href="web-assets/css/vendor/remixicon.css">
    ...
    <body class="rs-smoother-yes">
        ...
        <div id="pre-load">
            <div id="loader" class="loader">
                <div class="loader-container">
                    <div class="loader-icon"><img src="web-assets/images/favicon.png" alt=""></div>
                </div>
            </div>
        </div>
        <!-- preloader end -->
                        ...
                        <div class="rs-header-menu">
                            <nav id="mobile-menu" class="main-menu">
                                <ul class="onepage-menu">
                                    <li> <a href="#">Home</a></li>
                                    <li><a href="#homeabout">About Me</a></li>
                                    <li> <a href="#homeachievements">Achievements</a></li>
                                    <li><a href="#homebooks">Books</a> </li>
                                    <li><a href="#homemission">My Mission</a> </li>
                                </ul>
                            </nav>
                        </div>
                        <div class="rs-header-right">
                            <div class="rs-header-btn style-one d-none d-sm-block">
                                <a class="rs-btn has-theme-yellow has-radius" href="#homecontact">Contact Me
                                </a>
                            </div>
        ...
        <script src="web-assets/js/plugins/waypoints.min.js"></script>
        <script src="web-assets/js/vendor/bootstrap.bundle.min.js"></script>
        <script src="web-assets/js/plugins/meanmenu.min.js"></script>
        <script src="web-assets/js/plugins/swiper.min.js"></script>
        <script src="web-assets/js/plugins/wow.js"></script>
        <script src="web-assets/js/vendor/magnific-popup.min.js"></script>
        ...
        <script src="web-assets/js/plugins/nice-select.min.js"></script>
        <script src="web-assets/js/plugins/jarallax.min.js"></script>
        <script src="web-assets/js/vendor/ajax-form.js"></script>
        <script src="web-assets/js/plugins/easypie.js"></script>
        <script src="web-assets/js/plugins/headding-title.js"></script>
        <script src="web-assets/js/plugins/lenis.min.js"></script>
        <script src="web-assets/js/plugins/gsap.min.js"></script>
        <script src="web-assets/js/plugins/rs-anim-int.js"></script>
        <script src="web-assets/js/plugins/rs-scroll-trigger.min.js"></script>
        <script src="web-assets/js/plugins/rs-splitText.min.js"></script>
        <script src="web-assets/js/plugins/jquery.lettering.js"></script>
        <script src="web-assets/js/plugins/parallax-effect.min.js"></script>
        <script src="web-assets/js/vendor/purecounter.js"></script>
        <script src="web-assets/js/vendor/dark-light.js"></script>
