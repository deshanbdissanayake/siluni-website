                        ...
                        <div class="rs-banner-content">
                            ...
                            <div class="rs-banner-info-btn wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1.1s">
                                <div class="rs-banner-btn">
                                    <a class="rs-btn has-theme-yellow has-radius" href="#homeabout">Learn More
                                    </a>
                                </div>
                    ...
                    <div class="rs-about-content wow fadeInRight" data-wow-delay=".3s" data-wow-duration="1s">
                        <div class="rs-section-title-wrapper">
                            <span class="rs-section-subtitle justify-content-start has-theme-yellow">
                                A Heart for Service. A Mind for Excellence.
                            </span>
                            <h2 class="rs-section-title rs-split-text-enable split-in-fade mb-20">About Me</h2>
                            ...
                            <p class="rs-section-paragraph">My journey began with a fascination for numbers and a heartfelt mission to empower others through education. Whether it's through competitive math, publishing books, or simply helping my peers, I strive to make learning a source of strength for all. Here's a few highlights about me.</p>
                        </div>
                        <div class="rs-about-feature-list">
                            <ul>
                                ...
                                <li>
                                    <i class="ri-instagram-line"></i>
                                    Future aspirations: Mathematician. Change-maker.
                                </li>

                            </ul>
                        </div>
                        {{-- <div class="rs-about-btn">
                            <a class="rs-btn has-theme-yellow has-radius has-hover-black" href="#">Explore Our
                                Journey
                            </a>
                        </div> --}}
                    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-7 col-md-10">
                    <div class="rs-section-title-wrapper section-title-space text-center">
                        <span class="rs-section-subtitle justify-content-center has-theme-yellow">
                            Celebrating a Journey of Growth and Global Recognition
                        </span>
                    ...
                    <div class="rs-experience-wrapper wow fadeInLeft" data-wow-delay=".3s" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.3s; animation-name: fadeInLeft;">
                        ...
                        <div class="rs-experience-content">
                            <div class="rs-experience-item">
                                <div class="left-part">
                                    <span class="rs-meta">2025</span>
                                </div>
                                <div class="right-part">
                                    <h5 class="rs-experience-title">Grade 12  Student</h5>
                                    <span class="rs-experience-meta">Colombo International School </span>
                                </div>
                            </div>
                            <div class="rs-experience-item">
                                <div class="left-part">
                                    <span class="rs-meta">2022-23</span>
                                </div>
                                <div class="right-part">
                                    <h5 class="rs-experience-title">Secretary</h5>
                                    <span class="rs-experience-meta">Math Olympiad Club</span>
                                </div>
                            </div>
                            <div class="rs-experience-item">
                                <div class="left-part">
                                    <span class="rs-meta">2023-24</span>
                                </div>
                                <div class="right-part">
                                    <h5 class="rs-experience-title">Secretary</h5>
                                    <span class="rs-experience-meta">Math Olympiad society</span>
                                </div>
                            </div>
                            <div class="rs-experience-item">
                                <div class="left-part">
                                    <span class="rs-meta">2024-25</span>
                                </div>
                                <div class="right-part">
                                    <h5 class="rs-experience-title">President</h5>
                                    <span class="rs-experience-meta">Math Olympiad society</span>
                                </div>
                            </div>
                            <div class="rs-experience-item">
                                <div class="left-part">
                                    <span class="rs-meta">2017</span>
                                </div>
                                <div class="right-part">
                                    <h5 class="rs-experience-title">Graduated from UCMAS</h5>
                                    <span class="rs-experience-meta">Malaysia</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="rs-experience-wrapper wow fadeInRight" data-wow-delay=".3s" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.3s; animation-name: fadeInRight;">
                        ...
                        <div class="rs-experience-content">
                            <div class="rs-experience-item">
                                <div class="left-part">
                                    <span class="rs-meta">2016</span>
                                </div>
                                <div class="right-part">
                                    <h5 class="rs-experience-title">1st Place</h5>
                                    <span class="rs-experience-meta">UCMAS International Competition, Dubai, India, Malaysia</span>
                                </div>
                            </div>
                            <div class="rs-experience-item">
                                <div class="left-part">
                                    <span class="rs-meta">2018</span>
                                </div>
                                <div class="right-part">
                                    <h5 class="rs-experience-title">World Record Holder</h5>
                                    <span class="rs-experience-meta">Mental Arithmetic, Second Eurasian Women’s Forum, Russia</span>
                                </div>
                            </div>
                            <div class="rs-experience-item">
                                <div class="left-part">
                                    <span class="rs-meta">2x</span>
                                </div>
                                <div class="right-part">
                                    <h5 class="rs-experience-title">National Champion</h5>
                                    <span class="rs-experience-meta">UCMAS Sri Lanka</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-6">
                    ...
                    "Writing has always been my way of teaching, even before I stood in front of a classroom.”
                    </span>
                        <h2 class="rs-section-title rs-split-text-enable split-in-fade">Books by Siluni</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                                ...
                                <div class="rs-blog-wrapper">
                                    <div class="rs-blog-item">
                                        ...
                                        <div class="rs-blog-content">
                                            <h5 class="rs-blog-title"><a href="#">Tiny Gems - 2016</a></h5>
                                            <p class="rs-blog-desc">
                                                <strong>Tiny Gems</strong> is a heartfelt collection of essays written by Siluni at just 7 years old.
                                                Through simple yet powerful reflections, the book captures the beauty of childhood curiosity and
                                                the innocence of a young girl exploring the world through words. A celebration of wonder, emotion, and growth.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="rs-blog-wrapper">
                                    <div class="rs-blog-item">
                                        ...
                                        <div class="rs-blog-content">
                                            <h5 class="rs-blog-title"><a href="#">Early Math (2019)</a></h5>
                                            <p class="rs-blog-desc">
                                                <strong>Early Math</strong> is a playful, engaging educational series designed for young learners aged 6–7.
                                                Inspired by Siluni’s own journey with mental arithmetic, the book makes foundational math concepts fun,
                                                friendly, and easy to understand. A perfect starting point for curious young minds.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="rs-faq-wrapper rs-faq-three wow fadeInLeft" data-wow-delay=".3s" data-wow-duration="1s">
                        <div class="rs-section-title-wrapper mb-10">
                            ...
                            <h2 class="rs-section-title rs-split-text-enable split-in-fade">My mission is to heal, educate, and uplift. </h2>
                            <p class="rs-section-paragraph mt-4">As an aspiring mathematician, I’m not just chasing equations — I’m pursuing solutions to real-world problems. I believe mathematics is a universal language that can drive innovation, bridge inequalities, and improve lives. Whether it's advancing education, shaping policy with data-driven insights, or developing tools that solve everyday challenges, my goal is to use the power of math to create a smarter, fairer, and more compassionate world.</p>
                            <p class="rs-section-paragraph">Core Values: </p>
                            <div class="ms-4">
                                <ul>
                                    <li>
            ...
            <div class="row align-items-center g-5">
                <div class="col-xl-5 col-lg-5">
                    <div class="rs-contact-wrapper wow fadeInLeft" data-wow-delay=".3s" data-wow-duration="1s">
                        <div class="rs-section-title-wrapper section-title-space">
                            <span class="rs-section-subtitle justify-content-start has-theme-yellow">Have a question, opportunity, or message for Siluni?
                    </span>
                        ...
                        <div class="rs-contact-list">
                            ...
                            <div class="rs-contact-list-item">
                                ...
                                <div class="rs-contact-list-content">
                                    <span>Email</span>
                                    <h6><a href="mailto:siluniwalakulu2009@gmail.com">siluniwalakulu2009@gmail.com</a></h6>
                                </div>
                            </div>
                            <div class="rs-contact-list-item">
                                <div class="rs-contact-icon">
